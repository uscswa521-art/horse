...
將全世界直播主嘅**即時觀看人數**，變成一個你行得入去嘅**演唱會場館**：

> **一粒光點 = 一個真人。**
> 人愈多，鏡頭要拉得愈遠，舞台就細到得返一點 —— 就係你入到紅館企喺台邊
> 望返上去嗰種震撼。

再加**真實場館比例尺**（伊館 / 紅館 / 大球場 / 東京巨蛋 / 溫布萊 / 鳥巢），
一眼睇到「呢個台而家坐滿咗 **80 個紅館**」。

```
arena.html          ← 個 widget 本身 (一個檔搞掂, 零外部依賴)
...
| `cycle` | `1` | `0` = 唔好自動巡場 |
| `cycleSec` | `9` | 幾多秒轉一個台 |
| `dots` | `26000` | 畫面最多畫幾多粒光點（人多過呢個數，一粒就代表幾個人，畫面會誠實寫明） |
